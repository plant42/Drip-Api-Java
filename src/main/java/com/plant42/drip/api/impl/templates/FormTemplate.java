...
public class FormTemplate extends AbstractTemplate implements FormOperations {
    ...
    public FormTemplate(Retrofit retrofit, OkHttpClient client, ObjectMapper objectMapper) {
        super(retrofit, client, objectMapper);
    }

    @Override
    public void list(final String accountId, DeserializingCallback<List<Form>> callback) {
    ...
    @Override
    public void fetch(final String accountId, final String conversionId, final DeserializingCallback<List<Form>> callback) {
